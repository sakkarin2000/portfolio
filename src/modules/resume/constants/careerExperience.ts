...
export const careerExperiences: ICareerExperience[] = [
  {
    ...
    description: [
      ...
      "Collaborate closely with cross-functional teams including DevOps, QA, and Product Owner to deliver high-quality software solutions on time.",
      "Design and develop administration tools using React, for internal usage to streamlined multi-hierarchy configuration, feature flags and email notification template management which improved platform operational efficiency.",
    ],
